...
function Categories() {
  ...
  return (
    <section className="p-6 max-w-4xl mx-auto">
      ...
      <Title
        text="Indicate Your Books Categories"
        className="font-font2 text-customBlack mb-2 text-3xl"
      />
      <Description
        text="Let us know your book categories as a member in our community"
        className="font-font1 mb-8 text-customAsh  text-xs "
      />
